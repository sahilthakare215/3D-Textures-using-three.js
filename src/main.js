...
const grassAlbedo = textureLoader.load('/rawtextures/wispy-grass-meadow_albedo.png')
grassAlbedo.colorSpace = THREE.SRGBColorSpace
const grassAo = textureLoader.load('/rawtextures/wispy-grass-meadow_ao.png')
const grassHeight = textureLoader.load('/rawtextures/wispy-grass-meadow_height.png')
const grassMetallic = textureLoader.load('/rawtextures/wispy-grass-meadow_metallic.png')
const grassNormal = textureLoader.load('/rawtextures/wispy-grass-meadow_normal-ogl.png')
const grassRoughness = textureLoader.load('/rawtextures/wispy-grass-meadow_roughness.png')

// load the boulder textures
const boulderAlbedo = textureLoader.load('/rawtextures/badlands-boulders_albedo.png')
boulderAlbedo.colorSpace = THREE.SRGBColorSpace
const boulderAo = textureLoader.load('/rawtextures/badlands-boulders_ao.png')
const boulderHeight = textureLoader.load('/rawtextures/badlands-boulders_height.png')
const boulderMetallic = textureLoader.load('/rawtextures/badlands-boulders_metallic.png')
const boulderNormal = textureLoader.load('/rawtextures/badlands-boulders_normal-ogl.png')
const boulderRoughness = textureLoader.load('/rawtextures/badlands-boulders_roughness.png')

// load the space cruiser textures
const spaceCruiserAlbedo = textureLoader.load('/rawtextures/space-cruiser-panels2_albedo.png')
spaceCruiserAlbedo.colorSpace = THREE.SRGBColorSpace
const spaceCruiserAo = textureLoader.load('/rawtextures/space-cruiser-panels2_ao.png')
const spaceCruiserHeight = textureLoader.load('/rawtextures/space-cruiser-panels2_height.png')
const spaceCruiserMetallic = textureLoader.load('/rawtextures/space-cruiser-panels2_metallic.png')
const spaceCruiserNormal = textureLoader.load('/rawtextures/space-cruiser-panels2_normal-ogl.png')
const spaceCruiserRoughness = textureLoader.load('/rawtextures/space-cruiser-panels2_roughness.png')
...
boulderMaterial.aoMapIntensity = 1
...
spaceCruiserMaterial.aoMapIntensity = 1
